<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.master" AutoEventWireup="true" CodeFile="frmPrescriptionDetails.aspx.cs" Inherits="OPT_frmPrescriptionDetails" %>
...
<div><center><b><u><h1 style="font-family:Times New Roman; font-size:50px;">Prescription Details</h1></u></b></center></div><br />
    <div>
...
<td class="bold" style="font-family:Times New Roman; font-size:large;">From</td><td>
    ...
    <td><asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click" CssClass="form-control btn btn-block btn-warning">Search</asp:LinkButton></td>
</tr>
</table>
</div>
<br />
<div>
<asp:GridView ID="GridView2" runat="server" BackColor="White"  DataKeyNames="appointment_no"
