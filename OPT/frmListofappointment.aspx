...
<div><center><b><u><h1 style="font-family:Times New Roman; font-size:50px;">List Of Appointment</h1></u></b></center></div><br />
<div align="center">
...
<asp:GridView ID="GridView2" runat="server" BackColor="White"  DataKeyNames="appointment_no" CssClass=" table-bordered table-condensed"
        ...
        <ItemTemplate>
            ...
            <asp:ListItem Text="Acept" Value="A"></asp:ListItem>
        ...
        <ItemTemplate>
            <asp:TextBox ID="txtadoa" runat="server" class="form-control"></asp:TextBox>

            <rjs:PopCalendar ID="PopCalendar2" runat="server" Control="txtadoa" 
                Format="dd mmm yyyy" />
